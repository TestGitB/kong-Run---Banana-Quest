	...
	public static void initBanner(){
		...
		PTAdAdMobBridge.s_activity.get().runOnUiThread( new Runnable() {
            public void run() {
        		...
        		PTAdAdMobBridge.adView.setAdUnitId("ca-app-pub-5586353482678665/2904136232");
	...
	public static void initInterstitial(){
		...
		PTAdAdMobBridge.s_activity.get().runOnUiThread( new Runnable() {
            public void run() {
				...
				PTAdAdMobBridge.interstitial.setAdUnitId( "ca-app-pub-5586353482678665/4380869430" );
